...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1373: (x0,x1) => x0.add(x1),
      _1374: (x0,x1) => x0.remove(x1),
      _1375: Date.now,
      ...
      _3934: x0 => x0.userAgent,
      _6160: () => globalThis.document,
      _6221: x0 => x0.documentElement,
      _6234: x0 => x0.cookie,
      _6235: (x0,x1) => { x0.cookie = x1 },
      _6576: (x0,x1) => { x0.id = x1 },
      _6579: x0 => x0.classList,
      _6603: x0 => x0.children,
