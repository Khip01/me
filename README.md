...
- Run the ```flutter build web --release``` command _(more details in the [Flutter Docs - Web Build](https://docs.flutter.dev/platform-integration/web/renderers#command-line-options))_
